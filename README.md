...
**This is a completed solo submission.** All source lives in
[`code/`](code/); the original hackathon brief is preserved unchanged at
[`problem_statement.md`](problem_statement.md); development history is in
[`chat_transcript.md`](chat_transcript.md).

**Documentation map**
- **This README** — architecture, diagrams, a full request walkthrough, and current results.
- **[`code/ARCHITECTURE.md`](code/ARCHITECTURE.md)** — the same design in prose, with a section on known limitations.
- **[`code/evaluation/CALIBRATION.md`](code/evaluation/CALIBRATION.md)** — every parameter sweep, the full accuracy progression across 12 fixes, and every hypothesis tested and rejected.
- **[`code/evaluation/usage_report.md`](code/evaluation/usage_report.md)** — model usage and cost for the submitted run.
...
`code/evaluation/usage_report.md` discloses this in full. The live API path is
...
the scorer was completed (full story in `code/evaluation/CALIBRATION.md`):
...
[`code/evaluation/CALIBRATION.md`](code/evaluation/CALIBRATION.md).
...
hidden rows, in `code/evaluation/CALIBRATION.md`.
